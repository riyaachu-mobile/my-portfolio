...
class ExperienceSection extends StatelessWidget {
  ...
  static final List<_ExperienceData> _experiences = [
    _ExperienceData(
      ...
      highlights: [
        'Maintain and enhance complex government assistance application using Clean Architecture',
        'Implement CI/CD pipelines (GitHub Actions) for efficient builds and automated testing',
        'Automated iOS build generation and TestFlight deployment using xcrun',
        'Active SCRUM team member contributing to end-to-end Flutter migration',
        'Implement GoRouter for scalable navigation and hooks_riverpod for state management',
        'Developed AI-powered virtual assistant reducing support queries by 15%',
      ],
    ),
    _ExperienceData(
      role: 'Lead Flutter Developer & Native Mobile Engineer',
      company: 'LumiRx',
      ...
      highlights: [
        'Led development of Lumi Rx mobile application using Flutter for cross-platform compatibility',
        'Implemented NFC support via platform channels for prescription validation',
        'Built native NFC functionality for Android Instant Apps and iOS App Clips',
        'Mentor junior developers on best practices and architecture decisions',
        'Implemented parental guidance features with role-based access control',
        'Integrated OneSignal for cross-platform push notifications',
      ],
    ),
    _ExperienceData(
      ...
      highlights: [
        ...
        'Built real-time video calling (Twilio), chat system with video/image/PDF attachments',
      ...
      child: Column(
        ...
        children: [
          SectionHeader(
            ...
            subtitle:
                'Creating high-performance mobile applications with clean architecture and exceptional user experiences.',
          ),
